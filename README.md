...
Semantic HTML is a way of writing html that makes it easy on you, and future developers

2. Name two big differences between ```display: block;``` and ```display: inline;```.
block can have height and width while inline cannot

3. What are the 4 areas of the box model?
margin, border, padding, content

4. While using flexbox, what axis does the following property work on: ```align-items: center```?
y-axis (if not flipped)

5. Explain why git is valuable to a team of developers.
stores code version history and allows for development of projects together (and prevents code overwrites such as a case where people are working from a server directory)
